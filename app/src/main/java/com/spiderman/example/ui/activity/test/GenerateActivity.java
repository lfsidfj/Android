...
public class GenerateActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        mBarcodeWithContentIv = (ImageView) findViewById(R.id.iv_barcode_with_content);
        mBarcodeWithoutContentIv = (ImageView) findViewById(R.id.iv_barcode_without_content);
        createQRCode();
    }
    ...
    private void createChineseQRCodeWithLogo() {
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(GenerateActivity.this.getResources(), R.drawable.icon_return);
