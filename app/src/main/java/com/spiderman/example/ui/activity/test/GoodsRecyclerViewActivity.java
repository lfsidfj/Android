...
public class GoodsRecyclerViewActivity extends HttpBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        pagingBasePresenter=new PagingPresenter(GoodsRecyclerViewActivity.this, GoodsList.class, HttpAddress.GoodList,HttpAddress.GoodList);
